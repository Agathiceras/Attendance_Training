...
const RESTRICTION_CARD_BR = {type:'warnbox',h:'⚠️ What You Must Never Do',b:'Never offer a different course, group, or class time yourself — redirect the family to Customer Service instead. Never offer a 1-to-1 lesson without your TL\'s approval. And never offer an extra lesson on your own — that goes through your TL, or comes directly from Customer Service.'};
const REASON_GROUPS_LIST = {type:'list',h:'The six reasons in BO',p:'Pick the closest one honestly — some expand into a more specific option once selected.',items:['<strong>Health issues</strong>','<strong>Content issues</strong>','<strong>Vacation</strong> — traveling, school vacation, or holidays','<strong>Technical issues</strong> — student\'s computer, the Kodland platform or Classroom, a power outage, or an internet connection problem','<strong>Scheduling issues</strong> — moved to another group, or the lesson was rescheduled','<strong>Other</strong> — school load / exams / homework, a family reason, or no specific reason shared (a comment is required)']};

const REGIONS = [

{key:'latam',label:'LatAm (Spanish)',flag:'🌎',emoji:'🌎',desc:'Tutor-driven: you follow up, you escalate, your TL approves the extra lesson directly.',
  ...
  sections:[
   ...
   {t:'⏱️ Timing: Don\'t Wait for the Third Absence',cards:[
     ...
     {type:'table',h:'What changes as absences add up',head:['Count','What you do','By when'],rows:[
       ...
       ['Three or more, or any red nobody ever answered','Escalate through Tutors\' Evaluation in BO and tell your TL. This is no longer a private follow-up between you and the family.','Now'],
     ]},
   ...
   {t:'🔀 And Then? Two Ways This Goes',cards:[
     ...
     {type:'table',h:'They come back vs. they don\'t',head:['','✅ They come back','❌ They don\'t'],rows:[
       ['Straight away','Show them you noticed they were gone — warmly, and privately, not in front of the group. A student who returns to silence learns that their absence didn\'t matter.','Second contact to the family within 48 hours, on a different channel from the first. One unanswered message is not an unreachable family.'],
       ['Then','Watch their presence, not just their attendance. If they turn up but stay at 40% in the room, the problem has moved inside the lesson — that is Modules 2 to 4, not this one.','Open Tutors\' Evaluation in BO and message your TL. The case leaves the private follow-up here — that is the point of escalating, not a failure on your part.'],
       ['Who else you involve','Your TL, if the student has fallen behind enough to need an extra lesson (see the next section).','Your TL and Customer Service. CS takes over the contact attempts; your BO comment is what tells them what you have already tried, so write it before you hand over.'],
       ['The parents','Share one concrete thing the student did in the lesson they came back to. A specific win beats "they did well" and it reinforces the turnaround for the family too.','Keep them informed, and promise nothing. No extra lesson is offered before your TL approves it — "let me check on that" is a complete answer.'],
     ]},
     {type:'hi',h:'They came back, but they\'re still not really there.',b:'This is the most common outcome of all, and it is easy to file as solved because attendance recovered. It isn\'t solved: the student is now in the room and disengaged, which is a facilitation problem, not an absence problem. Their Classroom Presence will show it before you do.<br><br>That case belongs to Modules 2, 3 and 4 — how you open, who you call on, how you close.'},
   ]},
   {t:'🪜 If It Escalates: Requesting an Extra Lesson',cards:[
     ...
     {type:'flow',steps:[
       {ic:'📋',h:'1 · Open Tutors\' Evaluation',b:'In BO, select "An additional class is required" (this opens an OMNI ticket automatically). Two or more consecutive absences qualify — for Modules 1 and 8, one absence is enough. Maximum one extra lesson per student per month.',color:'blue'},
...
{key:'brazil',label:'Brazil (Portuguese)',flag:'🇧🇷',emoji:'🎈',desc:'Tutor-driven, like LatAm — but the escalation trigger is two absences, not one, and there\'s an explicit "never do" list.',
 m6:{emoji:'📞',title:'What to Do When a Student Misses Class',
  ...
  sections:[
   {t:'🎯 What You Select, and When',cards:[
     {type:'text',b:'Before anything else: two clicks, and the whole metric depends on them. Module 1 explained what red and yellow mean. Here is exactly when you choose which.'},
     {type:'doavoid',left:{h:'🔴 Select RED when…',items:['The student did not appear and nobody told you why. That is the only case.','Classroom marks this automatically the moment a lesson goes unattended.','Nobody can help a student whose problem is invisible.']},right:{h:'🟡 Select YELLOW when…',items:['Someone told you a reason — before or after the lesson. You then change it from red to yellow yourself and pick which of the six reasons it was.','Those options are not paperwork: they are the only way we ever learn which absences we could have prevented from our side.','Five seconds from you, and a pattern we can act on.']}},
     REASON_GROUPS_LIST,
     {type:'hi',h:'Marked red, and then the family answers? Change it.',b:'Change the absence to yellow and select the reason. That is not correcting a mistake — that is the process working: you reached out, you got an answer, and the record now matches reality.'},
   ...
   {t:'⏱️ Timing: The Two-Absence Trigger',cards:[
     {type:'text',b:'Module 1 introduced 🟡 yellow and 🔴 red absences. In Brazil, the escalation trigger is <strong>two absences</strong> — not a single unanswered red like in some other regions.'},
     {type:'simulation',title:'BO Simulation — Marking Attendance',src:'Simulacion_BO_Attendance_1.html'},
     {type:'table',h:'What changes as absences add up',head:['Count','What you do','By when'],rows:[
       ['One red absence','Contact the family yourself, get the reason, then change the absence to yellow and select it.','Same day. Never leave a red unexplained beyond 48 hours.'],
       ['One yellow absence','Share the recording and a short homework recap so they don\'t fall behind. Nothing to escalate.','Before the next lesson'],
       ['Two absences, or no reply after the second','This is the trigger — escalate now through Tutors\' Evaluation, so Customer Service can check in with the family directly.','Now'],
     ]},
     {type:'tip',txt:'Unlike LatAm\'s "any single unanswered red" trigger, Brazil waits for two — but not a day longer. If the family hasn\'t replied by the second absence, that\'s the moment to hand it to Customer Service.'},
     {type:'warn',txt:'"Tell someone — don\'t wait for the third." Two absences is exactly the point where a drifting student can still be brought back, and you\'re usually the only person who sees it early.'},
   ]},
   {t:'👨‍👩‍👧 Talking With Parents',cards:[
     {type:'imgtext',img:'Images/WhatsApp_module_6_ENG.png',items:['Be kind and understanding, especially if the absence was due to illness or a family issue.','If there\'s extra material available in the course, let them know.','When the student does attend, use the moment to share their achievements in class with the parents.','Warmth costs nothing and it is the whole difference between a family that stays engaged with the course and one that quietly stops replying.']},
     RESTRICTION_CARD_BR,
   ...
   {t:'📋 What to Log in Back Office',cards:[
     {type:'list',h:'Now a short checklist — the mechanism itself is in the first section above',items:['Set the absence type and the reason. Yellow plus the matching reason from the six groups if you were told why; red if nobody told you anything.','Add a comment with what the family actually said. Short is fine. This is what your TL and Customer Service read if the case leaves you.','If you\'re requesting an extra lesson, use the pre-filled comment template together with the link to the student\'s profile.']},
   ]},
   {t:'🔀 And Then? Two Ways This Goes',cards:[
     {type:'text',b:'You have contacted the family and recorded the absence. From here the situation goes one of two ways, and they need different things from you.'},
     {type:'table',h:'They come back vs. they don\'t',head:['','✅ They come back','❌ They don\'t'],rows:[
       ['Straight away','Show them you noticed they were gone — warmly, and privately, not in front of the group.','Second contact to the family, on a different channel from the first, before the second absence.'],
       ['Then','Watch their presence, not just their attendance. If they turn up but stay at 40% in the room, that\'s Modules 2 to 4, not this one.','Open Tutors\' Evaluation in BO after the second absence. The case leaves the private follow-up here.'],
       ['Who else you involve','Your TL, if the student has fallen behind enough to need an extra lesson.','Your TL, and Customer Service, who checks in with the family directly once you\'ve escalated.'],
       ['The parents','Share one concrete thing the student did in the lesson they came back to.','Keep them informed, and promise nothing — no extra lesson without your TL, and no course, group, or schedule change without redirecting to Customer Service.'],
     ]},
   ...
   {t:'🪜 If It Escalates: Requesting an Extra Lesson',cards:[
     {type:'text',b:'<strong>Contacting your TL first is correct</strong> — here is the complete path:'},
     {type:'flow',steps:[
       {ic:'📋',h:'1 · Open Tutors\' Evaluation',b:'In BO, select "An additional class is required." Two or more absences qualify — for Modules 1 and 8, one absence is enough. Maximum one extra lesson per student per month.',color:'blue'},
       {ic:'💬',h:'2 · Inform your TL',b:'Send them a private message so they can review and approve the case.',color:'coral'},
       {ic:'📞',h:'3 · Contact the family',b:'Only after approval, reach out directly to the family yourself to schedule the extra lesson (30 min, free of charge).',color:'green'},
       {ic:'⏰',h:'4 · If the student doesn\'t join',b:'Send a WhatsApp reminder. If there\'s still no response, the lesson is cancelled after 15 minutes.',color:'blue'},
       {ic:'✅',h:'5 · After the lesson',b:'You can update the student\'s attendance to green in BO.',color:'coral'},
     ]},
     {type:'text',b:'An extra lesson can also come directly from Customer Service, if they choose to offer one to the family themselves — but you should never offer one on your own without your TL\'s approval first.'},
     {type:'warnbox',h:'⚠️ If you started it, it stays with you',b:'If <strong>you</strong> initiated the case, do not redirect the student to Customer Service afterward — responsibility for seeing it through stays with you.'},
     {type:'text',h:'🖥️ Try It Yourself',b:'Time to practice how you\'d handle this in BO with a real case:'},
     {type:'simulation',title:'BO Simulation — Requesting an Extra Lesson',src:'Simulacion_BO_Attendance_2.html'},
   ]},
 ...
 quiz6:[
  {q:'A student has now missed two lessons in a row, and there was no response to your outreach after the first one. What\'s the best next step?',opts:['Wait for a third absence before doing anything else, since two absences alone doesn\'t confirm a pattern.','Report it now through Tutors\' Evaluation — two in a row is the point where you act, not wait for a third.','Stop reaching out and let Customer Service take over the case without any input from you.'],c:1,fb:'Two absences is Brazil\'s escalation trigger — don\'t wait for the third. That\'s exactly when the case should move from a private follow-up into Tutors\' Evaluation.'},
...
{key:'cis',label:'CIS (Russian)',flag:'🇷🇺',emoji:'📨',desc:'Customer Service contacts the family after the very first lesson; you flag it, your TL approves the extra lesson directly in BO.',
 ...
 m6:{emoji:'📞',title:'What to Do When a Student Misses Class',
  desc:'Marking the absence accurately, the one exception where you contact the family yourself, and how the extra-lesson approval works in CIS.',
  obj:'Know exactly what to select in Back Office and when, when you personally contact a family versus when Customer Service does, and how the extra-lesson approval works in CIS.',
  sections:[
   {t:'🎯 What You Select, and When',cards:[
     {type:'text',b:'Before anything else: two clicks, and the whole metric depends on them. Module 1 explained what red and yellow mean. Here is exactly when you choose which.'},
     {type:'doavoid',left:{h:'🔴 Select RED when…',items:['The student did not appear and nobody told you why. That is the only case.','Red is not a harsher label for the same event — it means we do not know what happened, which is what makes it the most dangerous state a student can be in.','Nobody can help a student whose problem is invisible.']},right:{h:'🟡 Select YELLOW when…',items:['Someone told you a reason — before or after the lesson. Then pick which of the six reasons it was.','Those options are not paperwork: they are the only way we ever learn which absences we could have prevented from our side.','Five seconds from you, and a pattern we can act on.']}},
   ...
   {t:'⏱️ Timing: Don\'t Wait for the Third Absence',cards:[
     ...
     {type:'table',h:'What changes as absences add up',head:['Count','What you do','By when'],rows:[
       ...
       ['One yellow absence','Share the recording and a short homework recap so they don\'t fall behind. Nothing to escalate.','Before the next lesson'],
       ['Two absences within a 4-week window','Flag it through Tutors\' Evaluation in BO — Customer Service takes it from there.','Within 48 hours of the second'],
       ['Three or more, or any red nobody ever answered','Escalate through Tutors\' Evaluation in BO — Customer Service takes over the case from there.','Now'],
     ]},
   ...
   {t:'🔀 And Then? Two Ways This Goes',cards:[
     ...
     {type:'table',h:'They come back vs. they don\'t',head:['','✅ They come back','❌ They don\'t'],rows:[
       ['Straight away','Show them you noticed they were gone — warmly, and privately, not in front of the group.','Customer Service makes the second contact attempt — not you, unless this was Module 1, Lesson 1.'],
       ['Then','Watch their presence, not just their attendance. If they turn up but stay at 40% in the room, that\'s Modules 2 to 4, not this one.','Open Tutors\' Evaluation in BO. The case leaves the private follow-up here.'],
       ['Who else you involve','Your TL, if the student has fallen behind enough to need an extra lesson.','Your TL, who approves directly in BO — and, for a student who never attended at all, your Client Manager rather than your TL.'],
       ['The parents','Share one concrete thing the student did in the lesson they came back to.','No extra lesson is promised before your TL approves it in BO.'],
     ]},
     {type:'hi',h:'They came back, but they\'re still not really there.',b:'This is the most common outcome of all, and it is easy to file as solved because attendance recovered. It isn\'t solved: the student is now in the room and disengaged, which is a facilitation problem, not an absence problem.<br><br>That case belongs to Modules 2, 3 and 4 — how you open, who you call on, how you close.'},
   ]},
   {t:'🪜 If It Escalates: Requesting an Extra Lesson',cards:[
     {type:'text',b:'The approval step works differently here — <strong>your TL reviews and approves your evaluation directly in BO</strong>, without a separate private message.'},
     {type:'flow',steps:[
       ...
       {ic:'✅',h:'2 · Your TL reviews it in BO',b:'No Slack ping needed — the approval happens on the evaluation itself, directly in Back Office.',color:'coral'},
       {ic:'📞',h:'3 · Contact the family',b:'Only after approval, reach out directly to the family yourself to schedule the extra lesson (30 min, free of charge).',color:'green'},
       {ic:'⏰',h:'4 · If the student doesn\'t join',b:'Send a reminder. If there\'s still no response, the lesson is cancelled after 15 minutes.',color:'blue'},
       {ic:'✅',h:'5 · After the lesson',b:'You can update the student\'s attendance to green in BO.',color:'coral'},
     ]},
     {type:'text',h:'🖥️ Try It Yourself',b:'Time to practice how you\'d handle this in BO with a real case:'},
     {type:'simulation',title:'BO Simulation — Requesting an Extra Lesson',src:'Simulacion_BO_Attendance_2.html'},
   ...
   {t:'🕳️ The Student Who Never Showed Up At All',cards:[
     ...
     {type:'text',b:'Once you\'ve flagged it, in CIS this case is handled by your <strong>Client Manager</strong> — not your TL. Follow the same 48-hour rule either way.'},
   ]},
  ]},
 quiz6:[
  {q:'Who contacts the family after a missed lesson, in most cases in CIS?',opts:['You do, personally, every time','Customer Service does, once you\'ve logged the type and reason','Nobody — the system handles it without any human contact'],c:1,fb:'Once you\'ve marked the absence, CS takes over contacting the family. The one exception is the student\'s very first lesson ever (Module 1, Lesson 1).'},
  ...
  {q:'In CIS, who approves your request for an extra lesson?',opts:['Your TL, reviewing your Tutors\' Evaluation directly in BO — no separate message needed','Customer Service, after they contact the family','You approve it yourself once the family agrees'],c:0,fb:'Unlike some other regions, in CIS there\'s no separate "message your TL on Slack" step — you submit the evaluation in BO and your TL reviews and approves it there directly.'},
 ],
},

{key:'eu',label:'EU (Italian & Polish)',flag:'🇮🇹-🇵🇱',emoji:'🏫',desc:'Customer Service owns escalation from Module 1; extra-lesson requests go through the Teaching Department. No BO negotiation simulation — marking mechanics only.',
 quiz1Q5:{q:'In Back Office, what turns a red (unexcused) absence into a yellow one?',opts:['Once the reason becomes known, changing the absence to yellow and selecting that reason','72 hours passing without any action','Leaving a comment in Back Office, without changing the absence type'],c:0,fb:'What turns a red absence yellow is changing the type and picking the reason once it\'s known — whether you found out directly or Customer Service passed it along. A comment on its own, without changing the type, leaves it red.'},
 m6:{emoji:'📞',title:'What to Do When a Student Misses Class',
  ...
  sections:[
   {t:'🎯 What You Select, and When',cards:[
     ...
     {type:'doavoid',left:{h:'🔴 Select RED when…',items:['The student did not appear and nobody told you why. That is the only case.','Red is not a harsher label for the same event — it means we do not know what happened, which is what makes it the most dangerous state a student can be in.','Nobody can help a student whose problem is invisible.']},right:{h:'🟡 Select YELLOW when…',items:['Someone told you a reason — before or after the lesson. Then pick which of the six reasons it was.','Those options are not paperwork: they are the only way we ever learn which absences we could have prevented from our side.','Five seconds from you, and a pattern we can act on.']}},
     REASON_GROUPS_LIST,
     {type:'hi',h:'Once you know the reason, change it.',b:'Change the absence to yellow and select the reason, as soon as you learn it — usually from Customer Service\'s notes on the student\'s profile. That is not correcting a mistake — that is the process working: the record now matches reality.'},
   ...
   {t:'🔁 Follow Up',cards:[
     {type:'list',items:['Review Customer Service\'s comments on your students\' profiles each week — that\'s how you know what to adapt and understand each absence.','The next time the student attends, show them you noticed their absence.']},
   ]},
   {t:'⏱️ Timing: The Escalation Timeline',cards:[
     ...
     {type:'table',h:'Where the student is',head:['Where the student is','What triggers escalation','What happens'],rows:[
       ...
       ['Module 2 onward','Two consecutive absences','This becomes a critical case — Tutors\' Evaluation now, same as elsewhere'],
       ['Italy specifically','Three red absences in a row','Triggers a forced pause on the course — flag it the moment you see the third'],
     ]},
   ...
   {t:'📋 What to Log in Back Office',cards:[
     {type:'list',h:'Now a short checklist — the mechanism itself is in the first section above',items:['Set the absence type and the reason. Yellow plus the matching reason from the six groups if you were told why; red if nobody told you anything.','Add a comment with what the family actually said. Short is fine. This is what Customer Service and the Teaching Department read if the case escalates.','If you\'re requesting an extra lesson, use the pre-filled comment template together with the link to the student\'s profile.']},
   ]},
   {t:'🔀 And Then? Two Ways This Goes',cards:[
     {type:'text',b:'You have contacted the family and recorded the absence. From here the situation goes one of two ways, and they need different things from you.'},
     {type:'table',h:'They come back vs. they don\'t',head:['','✅ They come back','❌ They don\'t'],rows:[
       ['Straight away','Show them you noticed they were gone — warmly, and privately, not in front of the group.','Customer Service already has this — an automated message went out, and CS has been watching since Module 1.'],
       ['Then','Watch their presence, not just their attendance. If they turn up but stay at 40% in the room, that\'s Modules 2 to 4, not this one.','If it reaches two consecutive absences (or three red in a row, in Italy), it becomes a critical case automatically — your Tutors\' Evaluation confirms it on your end.'],
       ['Who else you involve','Your TL, if the student has fallen behind enough to need an extra lesson.','Customer Service and the Teaching Department — already looped in per the timeline above.'],
       ['The parents','Share one concrete thing the student did in the lesson they came back to.','Keep them informed, and promise nothing. No extra lesson is offered before it\'s approved.'],
     ]},
     {type:'hi',h:'They came back, but they\'re still not really there.',b:'This is the most common outcome of all, and it is easy to file as solved because attendance recovered. It isn\'t solved: the student is now in the room and disengaged, which is a facilitation problem, not an absence problem.<br><br>That case belongs to Modules 2, 3 and 4 — how you open, who you call on, how you close.'},
   ]},
   {t:'🪜 If It Escalates: Requesting an Extra Lesson',cards:[
     ...
     {type:'flow',steps:[
       {ic:'📋',h:'1 · Open Tutors\' Evaluation',b:'In BO, select "An additional class is required." Two or more consecutive absences qualify — for Modules 1 and 8, one absence is enough. Maximum one extra lesson per student per month.',color:'blue'},
       {ic:'📨',h:'2 · Customer Service picks it up',b:'CS reviews your evaluation and creates the extra-lesson request on the student\'s behalf.',color:'coral'},
       {ic:'🏫',h:'3 · The Teaching Department reviews',b:'Approval comes from here, not directly from your TL.',color:'green'},
       {ic:'📞',h:'4 · Contact only after approval',b:'Once approved, you schedule the 30-minute lesson with the family, free of charge.',color:'blue'},
       {ic:'✅',h:'5 · After the lesson',b:'You can update the student\'s attendance to green in BO.',color:'coral'},
     ]},
     {type:'text',b:'There\'s no BO negotiation simulation for this course track — once Customer Service and the Teaching Department are in the loop, running that step is theirs, not yours.'},
   ]},
   {t:'🕳️ The Student Who Never Showed Up At All',cards:[
 ...
 quiz6:[
  {q:'When does Customer Service first get involved with a student\'s absences?',opts:['Only once the tutor escalates through Tutors\' Evaluation','From Module 1 — even a single absence is already on their radar','Only after three unexplained absences'],c:1,fb:'CS is already watching from a student\'s very first module — a single absence there is enough for them to reach out.'},
  {q:'A student missed class due to illness. How does the tutor talk to the parent?',opts:['Keep the conversation brief and neutral, avoiding personal questions about the illness so as not to intrude on the family\'s situation.','Express genuine concern for how the student is doing, mention any extra material available, and use their return to share something positive.','Focus mainly on catching the student up academically, since reassurance about the illness isn\'t really part of the tutor\'s role.'],c:1,fb:'Genuine warmth, practical help, and a positive note on their return covers the empathy this module asks for — staying neutral or purely academic misses it.'},
  {q:'A student who missed two classes returns and does great work today. How does the tutor use this with the parents?',opts:['Wait until the next scheduled check-in to mention it, to avoid contacting the family too many times in a short period.','Reach out around this class to share the specific achievement, reinforcing the positive turnaround for both student and parent.','Mention it briefly to the student only, since parents are usually more interested in attendance patterns than daily achievements.'],c:1,fb:'Sharing the achievement while it\'s fresh reinforces the turnaround for both student and parent — waiting or keeping it from the parent wastes the moment.'},
...
{key:'simplified',label:'MENA · GCC · Turkey · UK · US · Asia',flag:'🇦🇪-🇹🇷-🇬🇧-🇺🇸-🇮🇩',emoji:'📇',desc:'Customer Service manages the whole outreach and the extra-lesson request. Your part: mark it accurately, and know where to read what CS found out.',
 ...
 m6:{emoji:'📞',title:'What to Do When a Student Misses Class',
  ...
  sections:[
   ...
   {t:'🔁 Follow Up',cards:[
     {type:'list',items:['Share the class recording along with a short homework recap, so the student doesn\'t fall behind — this part is still yours.','The next time the student attends, show them you noticed their absence.','You don\'t need to personally chase the family — Customer Service already has it.']},
   ]},
   {t:'⏱️ Timing: What the Count Actually Triggers',cards:[
     {type:'text',b:'In this region, these thresholds don\'t trigger something you do — they trigger something that happens to the student, automatically, on Customer Service\'s side.'},
   ...
   {t:'🔀 And Then? Two Ways This Goes',cards:[
     ...
     {type:'table',h:'They come back vs. they don\'t',head:['','✅ They come back','❌ They don\'t'],rows:[
       ['Straight away','Show them you noticed they were gone — warmly, and privately, not in front of the group.','Customer Service makes the follow-up contact — not you.'],
       ['Then','Watch their presence, not just their attendance. If they turn up but stay at 40% in the room, that\'s Modules 2 to 4, not this one.','Customer Service manages the case from here.'],
       ['Who else you involve','Customer Service, either way — they manage both outcomes.','Loop in your TL only if you want to flag a specific concern about the pattern.'],
       ['The parents','Share one concrete thing the student did in the lesson they came back to.','You don\'t need to reach out — CS is already doing that.'],
     ]},
     {type:'hi',h:'They came back, but they\'re still not really there.',b:'This is the most common outcome of all, and it is easy to file as solved because attendance recovered. It isn\'t solved: the student is now in the room and disengaged, which is a facilitation problem, not an absence problem.<br><br>That case belongs to Modules 2, 3 and 4 — how you open, who you call on, how you close.'},
   ]},
 ...
 quiz6:[
  {q:'A student misses a lesson with no warning. Who contacts the family?',opts:['You do, the same day','Customer Service does, usually within 3–4 days','Nobody — the system sends an automated message only'],c:1,fb:'In this region, CS handles the outreach directly. Your part is marking the absence and the reason accurately.'},
